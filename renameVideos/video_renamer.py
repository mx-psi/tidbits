...
to_remove = set(
  map(
    lambda x: x.lower(), [
      "1080p", "720p", "BrRip", "DVDRip", "YIFY", "BOKUTOX", "x264", "WEB-DL",
      "HDTV", "H264", "AAC", "HDRip", "AC3-EVO", "x265", "WEBRip",
      "x264-[MULVAcoded]", "DVDScr", "XviD-ETRG", "AC3", "2.0-EVO"
    ]))
...
if __name__ == "__main__":
  ...
  parser.add_argument(
    "-n", "--dry-run", help = "Only shows renames", action = "store_true")
